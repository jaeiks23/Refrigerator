...
function createhtml61(data){
	...
	deadData.forEach((fruit) =>{
		...
		datalist.push(`
                ${(fruit.ing_deadline==null)?`<div style="display: inline-block;">
                ...
                </div>`:(now<new Date(fruit.ing_deadline))?`<div style="display: inline-block;">
                        <button class = "rec_ing" value = "${fruit.id}" style="display: block; border-radius: 500px;  border: solid 1px;">
                            <img src = "${fruit.srcs} "width="20px" height="27px">
                        ...
                        <button class = "rec_ing" value = "${fruit.id}" style="display: block; border-radius: 500px;  border: solid red 1px; background-color:black;">
                            <img src = "${fruit.srcs} "width="20px" height="27px">
